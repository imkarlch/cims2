...
$status = "Available";
 $sql="INSERT INTO stock(bar_code,medicine_name, category, quantity,remain_quantity,act_remain_quantity, register_date, expire_date,status) 
 VALUES ('$bar_code','$med_name','$category','$quantity','$quantity','$quantity','$new_reg_date','$new_exp_date','$status')";
