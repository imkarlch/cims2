  ...
  <div class="navbar navbar-inverse navbar-fixed-top"><!--***HEADER****---->
      <div class="navbar-inner">
        ...
        <span class="icon-bar"></span>
          ...
          <a class="brand" href="#"><b>Cafe Inventory Monitoring System</b></a>
...
<!-- For more projects: Visit codeastro.com  -->
      ...
      <div class="row">
        <div class="contentheader">
          <h1>Products</h1>
            ...
            <input type="text" size="4"  id="med_quantity" onkeyup="quanti()" placeholder="Filter using Product Name" title="Type Product Name">
           ...
           <a href="index.php?invoice_number=<?php echo $_GET['invoice_number']?>" id="popup"><button class="btn btn-success btn-md" name="submit"><span class="icon-plus-sign icon-large"></span> Add New Item</button></a>
    ...
    ?>
      ...
      <div style="text-align:center;">
        Total Products : <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $row;?>]</font>
      </div>
    ...
    <div class="row">
      <div class="col-12">
        <form method="POST">
          ...
          <table id="table0" class="table table-bordered table-striped table-hover">
           <thead>
             ...
             <th style="background-color: #c53f3f;" width="6%">Expiry Date</th>
        ...
        <?php $sql = "SELECT  id,bar_code, medicine_name, category, quantity,used_quantity, remain_quantity,act_remain_quantity, register_date, expire_date, status FROM stock order by id desc"; ?>
