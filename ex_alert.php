...
<head>
	...
	<script type="text/javascript">
		...
		function med_name() {//***Search For Product *****
...
<body>
	   ...
	   <div class="expire" color="green" >
    	  <font size="5">Item Going to Expired</font><br><hr>
    	  <input type="text"  id="name_med" size="4"  onkeyup="med_name()" placeholder="Search for Product names.." title="Type in a name">
