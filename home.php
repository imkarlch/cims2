...
//GET Product Name And Expire Date
 ...
 <div class="container">
   ...
   <div class="container">
    ...
    <center>
     ...
     <input type="text" id="product" required  autocomplete="off" placeholder="Product Name" style="width:400px;height: 30px;">
     <!-- <div class="ui-widget"> -->
